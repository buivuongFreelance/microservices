  ...
  private securityMiddleware(app: Application): void {
    ...
    app.use((req: Request, _res: Response, next: NextFunction) => {
      if (req.session?.jwt) {
        ...
        // axiosBuyerInstance.defaults.headers[
        //   "Authorization"
        // ] = `Bearer ${req.session?.jwt}`;
        // axiosSellerInstance.defaults.headers[
        //   "Authorization"
        // ] = `Bearer ${req.session?.jwt}`;
        // axiosGigInstance.defaults.headers[
        //   "Authorization"
        // ] = `Bearer ${req.session?.jwt}`;
        // axiosMessageInstance.defaults.headers[
        //   "Authorization"
        // ] = `Bearer ${req.session?.jwt}`;
        // axiosOrderInstance.defaults.headers[
        //   "Authorization"
        // ] = `Bearer ${req.session?.jwt}`;
        // axiosReviewInstance.defaults.headers[
        //   "Authorization"
        // ] = `Bearer ${req.session?.jwt}`;
      }
      next();
