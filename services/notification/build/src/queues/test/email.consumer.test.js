...
jest.mock("amqplib");
jest.mock("@microservices-shared/common");
describe("Email Consumer", () => {
    ...
    describe("consumeAuthEmailMessages method", () => {
        it("should be called", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(connectionChannel.assertExchange).toHaveBeenCalledWith("micro-email-notification", "direct");
            expect(connectionChannel.assertQueue).toHaveBeenCalledTimes(1);
            expect(connectionChannel.consume).toHaveBeenCalledTimes(1);
            expect(connectionChannel.bindQueue).toHaveBeenCalledWith("auth-email-queue", "micro-email-notification", "auth-email");
        }));
    });
    describe("consumeOrderEmailMessages method", () => {
        it("should be called", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(connectionChannel.assertExchange).toHaveBeenCalledWith("micro-order-notification", "direct");
            expect(connectionChannel.assertQueue).toHaveBeenCalledTimes(1);
            expect(connectionChannel.consume).toHaveBeenCalledTimes(1);
            expect(connectionChannel.bindQueue).toHaveBeenCalledWith("order-email-queue", "micro-order-notification", "order-email");
        }));
    });
});
