...
const common_1 = require("@microservices-shared/common");
const connection_1 = require("../queues/connection");
const mail_transport_1 = require("../queues/mail.transport");
const log = (0, common_1.winstonLogger)(`${config_1.config.ELASTIC_SEARCH_URL}`, "emailConsumer", "debug");
function consumeAuthEmailMessages(channel) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const exchangeName = "micro-email-notification";
            const routingKey = "auth-email";
            const queueName = "auth-email-queue";
            yield channel.assertExchange(exchangeName, "direct");
            const microQueue = yield channel.assertQueue(queueName, {
                durable: true,
                autoDelete: false,
            });
            yield channel.bindQueue(microQueue.queue, exchangeName, routingKey);
            channel.consume(microQueue.queue, (msg) => __awaiter(this, void 0, void 0, function* () {
                const { receiverEmail, username, verifyLink, resetLink, template } = JSON.parse(msg.content.toString());
                const locals = {
                    appLink: `${config_1.config.CLIENT_URL}`,
                    appIcon: "https://hotpot.ai/designs/thumbnails/app-store-icon/2.jpg",
                    username,
                    verifyLink,
                    resetLink,
                };
...
function consumeOrderEmailMessages(channel) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const exchangeName = "micro-order-notification";
